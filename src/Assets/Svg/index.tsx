...
export const MarathonIcon = () => (
  <svg className="w-6 h-6 stroke-current text-white-500" viewBox="0 0 24 24">
    <path
...
export const InstagramIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.332 3.608 1.308.975.976 1.246 2.243 1.308 3.608.058 1.267.07 1.647.07 4.851s-.012 3.584-.07 4.85c-.062 1.366-.332 2.633-1.308 3.608-.976.975-2.243 1.246-3.608 1.308-1.267.058-1.647.07-4.851.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.332-3.608-1.308-.975-.976-1.246-2.243-1.308-3.608-.058-1.267-.07-1.647-.07-4.851s.012-3.584.07-4.85c.062-1.366.332-2.633 1.308-3.608.976-.975 2.243-1.246 3.608-1.308 1.267-.058 1.647-.07 4.851-.07zm0-2.163c-3.259 0-3.67.014-4.947.072-1.737.08-3.28.447-4.47 1.637-1.19 1.19-1.557 2.733-1.637 4.47-.058 1.277-.072 1.688-.072 4.947s.014 3.67.072 4.947c.08 1.737.447 3.28 1.637 4.47 1.19 1.19 2.733 1.557 4.47 1.637 1.277.058 1.688.072 4.947.072s3.67-.014 4.947-.072c1.737-.08 3.28-.447 4.47-1.637 1.19-1.19 1.557-2.733 1.637-4.47.058-1.277.072-1.688.072-4.947s-.014-3.67-.072-4.947c-.08-1.737-.447-3.28-1.637-4.47-1.19-1.19-2.733-1.557-4.47-1.637-1.277-.058-1.688-.072-4.947-.072zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zm0 10.162a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 11-2.88 0 1.44 1.44 0 012.88 0z"
      fill="#fff"
    />
  </svg>
);
...
export const FacebookIcon = () => (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M22.676 0H1.324C.592 0 0 .592 0 1.324v21.352C0 23.408.592 24 1.324 24H12.82v-9.294H9.692v-3.623h3.128V8.41c0-3.1 1.894-4.788 4.66-4.788 1.324 0 2.46.098 2.79.142v3.235h-1.916c-1.504 0-1.797.715-1.797 1.763v2.31h3.593l-.468 3.622h-3.125V24h6.127C23.408 24 24 23.408 24 22.676V1.324C24 .592 23.408 0 22.676 0z"
      fill="#fff"
    />
  </svg>
);
