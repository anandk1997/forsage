    ...
    <DashboardLayout>
      <main class="flex flex-1 w-full">
        <div class="flex flex-col w-full space-y-10 sm:space-y-7.5">
          ...
          <div class="flex justify-between xl:justify-start space-x-5 xl:flex-col sm:px-5 xl:space-x-0">
            <div class="flex flex-col p-7.5 sm:p-5 rounded bg-black-light w-full max-w-470px xl:max-w-full xl:mb-10 sm:mb-5">
              <div class="flex w-full justify-between items-center sm:flex-col sm:items-start sm:space-y-2.5">
                <div class="flex items-center">
                  <span class="text-white-500 text-base">New partners by </span>
                  <div class="flex relative">
                    <div class="flex">
                      <div class="flex ml-1 items-center w-20 cursor-pointer">
                        <span class="text-white text-base">month</span>
                        <svg
                ...
                <div class="flex space-x-3">
                  <div class="flex relative">
                    <div class="flex">
                      <div class="inline-flex cursor-pointer px-2.5 bg-blue-100 hover:bg-main-blue-300 text-main-blue rounded text-base !leading-8 w-max sm:text-base">
                        February
                      </div>
                    </div>
                  </div>
                  <div class="flex relative">
                    <div class="flex">
                      <div class="inline-flex cursor-pointer px-2.5 bg-blue-100 text-main-blue rounded text-base !leading-8 w-max sm:text-base hover:bg-main-blue-300">
                        2024
                      </div>
                    </div>
                  </div>
              ...
              <div class="flex flex-shrink w-full h-full max-h-52 sm:h-40 mt-5 max-w-470px xl:max-w-700px lg:max-w-full sm:mt-5">
                <div class="flex flex-shrink w-full h-full max-h-52 sm:h-40 mt-8 max-w-470px xl:max-w-700px lg:max-w-full">
                  <div
            ...
            <div class="flex flex-col overflow-hidden space-y-10 sm:space-y-5 xl:w-full">
              <div class="flex space-x-2 overflow-auto sm:space-x-5">
                <div class="xl:flex-grow sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                  <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                    <div class="flex items-center z-[10]">
                      <span class="text-white-500 text-base sm:text-sm sm:whitespace-nowrap">
                        Link clicks
                      </span>
                      <div class="relative group">
                        ...
                        <div
                          class="__react_component_tooltip t7c74018c-d5f3-42b1-b414-a4ff6c3f7121 place-bottom type-dark"
                          id="Link clicks"
                          data-id="tooltip"
                        >
                        ...
                        > --> */}
                          Total number of visitors by your link and last 24
                          hours change
                        </div>
                      </div>
                    </div>
                    <span class="text-white text-2xl font-bold notranslate sm:text-xl !mt-1 !sm:mt-2.5 mt-5 sm:mt-2.5">
                      58471
                    </span>
                  </div>
                  <div class="flex p-2.5 w-full">
                    <div class="w-full bg-white-100 text-white rounded p-2 flex text-base items-center justify-between notranslate sm:text-sm">
                      <div class="flex items-center justify-start">
                        <svg
                          class="stroke-current mr-1.5"
                          width="8"
                          height="11"
                          stroke="#2CFF4E"
                          xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="xl:flex-grow sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                  ...
                  <div class="flex p-2.5 w-full">
                    <div class="w-full bg-green-100 text-green-light rounded p-2 flex text-base items-center justify-between notranslate sm:text-sm">
                      <div class="flex items-center justify-start">
                        <svg
                          class="stroke-current mr-1.5"
                          width="8"
              ...
              <div class="flex flex-1 overflow-hidden w-full relative justify-start items-end bg-black-light rounded desktop-infoblock-chart-base lg:!w-full lg:!max-w-full">
                <div class="flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                  <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                    <div class="flex items-center z-[10]">
                      <span class="text-white-500 text-base sm:text-sm sm:whitespace-nowrap">
                        Profits
          ...
          <div class="w-full sm:px-5">
            <div
              id="xQoreLink"
              class="flex flex-wrap sm:flex-col sm:right-5 w-full p-7 justify-between bg-dark-blue-100 rounded sm:p-5"
            >
              <div class="flex flex-col">
                <div class="flex items-center mb-2.5">
                  <span class="text-base text-white-500">Personal link</span>
                  <div class="relative group">
                    <button
                      class="flex justify-center items-center text-center text-base font-bold text-white rounded-mini sm:text-sm outline-none ml-1.5"
                      data-tip="true"
                    ...
                    <div
                      class="__react_component_tooltip t1862f9e5-2e79-473d-89c3-76245e1a6e19 place-bottom type-dark"
                      id="Personal link"
                      data-id="tooltip"
                    >
                      {/* <!-- <style aria-hidden="true">
                ...
                <span class="text-3xl font-bold text-main-blue sm:text-xl sm:mb-5">
                  forsage.io/b/xqg1z8
                </span>
              </div>
              <div class="flex items-end space-x-7 sm:space-x-2.5 mt-2.5">
                <button class="flex justify-center items-center text-center text-base font-bold text-white rounded-mini sm:text-sm outline-none px-5 py-3 bg-main-blue text-white hover:bg-hover-main-blue active:bg-active-main-blue rounded-mini sm:rounded sm:py-0 sm:px-2.5 sm:leading-30px">
                  Copy
                  <svg
                    class="w-5 h-5 ml-2.5 stroke-current text-white sm:hidden"
                    viewBox="0 0 20 20"
                    fill="#fff"
                    xmlns="http://www.w3.org/2000/svg"
                  >
          ...
          <div class="w-full sm:px-5">
            <div class="flex flex-wrap sm:flex-col sm:right-5 w-full p-7 justify-between bg-green-100 rounded sm:p-5">
              <div class="flex flex-col">
                <div class="flex items-center mb-2.5">
                  <span class="text-base text-white-500">
                    Personal link{" "}
                    <span class="text-program-green">MaxQore</span>
                  </span>
                  <div class="relative group">
                    <button
                      class="flex justify-center items-center text-center text-base font-bold text-white rounded-mini sm:text-sm outline-none ml-1.5"
                    ...
                    <div
                      class="__react_component_tooltip td8f7d021-c154-4891-bf19-a2f41f1d11b0 place-bottom type-dark"
                      id="Personal link"
                      data-id="tooltip"
                    >
                      {/* <!-- <style aria-hidden="true">
                ...
                <span class="text-3xl font-bold text-program-green sm:text-xl sm:mb-5">
          ...
          <div class="w-full sm:px-5">
            <div class="flex flex-wrap sm:flex-col sm:right-5 w-full p-7 justify-between bg-cyan-150 rounded sm:p-5">
              <div class="flex flex-col">
                <div class="flex items-center mb-2.5">
                  <span class="text-base text-white-500">
                    Personal link <span class="text-cyan-500">xQore</span>
                  </span>
                  <div class="relative group">
                    <button
                      class="flex justify-center items-center text-center text-base font-bold text-white rounded-mini sm:text-sm outline-none ml-1.5"
                    ...
                    <div
                      class="__react_component_tooltip t9ee9ae55-62ae-428c-9d2f-cee33f37b485 place-bottom type-dark"
                      id="Personal link"
                      data-id="tooltip"
                    >
                      {/* <!-- <style aria-hidden="true">
                ...
                <span class="text-3xl font-bold text-cyan-500 sm:text-xl sm:mb-5">
                  forsage.io/q/xqg1z8
                </span>
              </div>
              <div class="flex items-end space-x-7 sm:space-x-2.5 mt-2.5">
          ...
          <div class="w-full sm:px-5">
            <div class="w-full custom_invite_pdf_bg h-[200px] sm:h-full rounded-[20px] py-10 px-7.5 relative sm:py-2.5 overflow-hidden">
              <div class="flex flex-col justify-between h-full sm:items-center">
                <span class="text-white text-3xl font-semibold z-[1] sm:text-lg sm:font-medium">
                  Create custom invite PDF
                </span>
                <img
                  class="absolute right-0 top-[-80px] rounded-[20px] z-[0] sm:relative sm:top-0"
                  src="/customInvitePdf/links/programs.png"
                />
                <button class="flex justify-center items-center text-center text-base font-bold text-white rounded-mini sm:text-sm outline-none w-full creat_PDF_button_bg w-[300px] py-3 z-[1] sm:w-full">
                  <span class="">Create PDF</span>
                </button>
              </div>
              <img
                class="absolute top-[35px] left-[250px] sm:left-[-30px] sm:top-auto sm:bottom-[-100px]"
                src="/customInvitePdf/links/binance.png"
              />
              <img
                class="absolute top-[-95px] right-[-100px]"
                src="/customInvitePdf/links/binance.png"
              />
            </div>
          </div>
            ...
            >
              ...
              <div class="flex flex-col">
                <div class="flex flex-col px-5">
                  <span class="text-white text-3xl mb-2.5 sm:text-2xl">
                    Custom links
                  </span>
                  <span class="text-white-500 text-base w-full sm:w-full sm:text-sm">
                    Promote different teams by using cutom links, Create and set
                    up custom links for your team. Include as many participants
                    in your link as you want and set up how the new
                    registrations will be distributed within the group.
                  </span>
                </div>
                <div class="grid grid-cols-2 w-full gap-10 xl:grid-cols-1 lg:gap-5 mt-7.5">
                  <div class="xl:max-w-full max-w-1/2 flex flex-col bg-black-light rounded sm:rounded-none p-7.5 sm:p-5 relative">
                    <span class="text-white text-2xl mb-7 sm:mb-5 sm:text-xl">
                      Custom link #1
                    </span>
                    <div class="flex sm:flex-col w-full bg-blue-100 justify-between items-center rounded-lg py-2 px-2.5 mb-7 sm:p-5 sm:mb-5 sm:items-start">
                      <span class="text-main-blue text-base font-bold sm:mb-2.5">
                        forsage.io/br/c4pk5kx4c
                      </span>
                      <div class="flex space-x-2.5">
                        <button class="flex justify-center items-center text-center text-base font-bold text-white rounded-mini sm:text-sm outline-none py-0 px-2.5 bg-main-blue text-white rounded !leading-30px hover:bg-hover-main-blue active:bg-active-main-blue sm:leading-30px">
                          Copy
                        </button>
                      </div>
                    </div>
                    <div class="flex flex-nowrap overflow-auto space-x-3 w-full">
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            <span class="text-white-500 text-base sm:text-sm sm:whitespace-nowrap">
                              Clicks
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t9895ced3-b499-47bc-9c70-1db50a9a12c6 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                          ...
                          <span class="text-white text-2xl font-bold notranslate sm:text-xl false false">
                            50
                          </span>
                        </div>
                        <div class="p-5 pt-0 flex text-green-light text-base items-baseline notranslate sm:text-sm">
                          +0
                        </div>
                      </div>
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip te07acdf5-7aad-4c08-91a1-69fcd25c9e89 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t30093072-de9b-476f-a125-de634911c673 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                    ...
                    <div class="flex flex-wrap space-x-2.5 justify-between mt-7.5">
                      <div class="flex sm:flex-col space-x-2.5 sm:space-x-0 sm:space-y-1">
                        <span class="block text-white-500 text-base sm:text-sm">
                          Owner
                        </span>
                        <div class="flex">
                          <span class="text-white-900 text-base sm:text-sm">
                            ID 1
                          </span>
                        </div>
                      </div>
                      <div class="flex sm:flex-col sm:items-end space-x-2.5 sm:space-x-0 sm:space-y-1">
                        <span class="block text-white-500 text-base sm:text-sm">
                          Participants
                        </span>
                        <div class="flex">
                          <span class="block text-white text-base sm:text-sm">
                            0
                          </span>
                        </div>
                      </div>
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t2510c138-c247-48ea-b941-22cb9a374f17 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tfaad49f5-3cb4-4707-bff7-91a6d0b80b47 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t09a25788-5070-498d-83e1-29db7f0381d1 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tb3ed1fa1-1ddb-4e26-8759-5e8a782b47d9 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tfa58b91b-4cce-47cd-87e6-40e87f075038 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tc23a65f2-faf8-4cf5-b61b-c1868cad6040 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t4a793110-ea4b-4315-97a8-f1aa71777922 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t32075980-ecb3-4552-923b-0de0730cc9a1 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t549dcd5f-ee47-43b2-9ced-848497c18f73 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t37e326a7-774a-4aad-9ff1-14660c9d5e3b place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tc90e672f-1c4f-4692-9d91-1e7a203588ab place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t8c7a60ae-602f-4822-8641-029907beb6b2 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tbcd08bf2-e4b9-4c60-86be-42af9d6fc05c place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t3f94b640-61f4-49c1-9db2-454b4d615a38 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t9d317e30-9427-40bc-b6c8-d5c902cb6239 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tdef6555e-bf7f-4183-a764-ef9bbefeeb80 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t84d78bae-a49c-4bdd-86b7-5ec38f1e8ff9 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t5db8253f-fcb6-4552-8de7-5ae4eef175ad place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t6b5b7f67-abea-43c9-8c64-160efa60dfc1 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tf79edc8f-b942-4ffd-9743-4a22efb47c69 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t5651f3b9-3bd9-4a1e-8742-53ae059d2e04 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t759fe17a-a064-4268-bbed-c46d573a1450 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t152528f1-6509-43b8-b080-8ad92ac4a434 place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip ta7645ce4-f29c-44ac-bb59-91b009dfaf72 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip t0469ef7b-0fcd-4279-a852-707dd724c674 place-bottom type-dark"
                                id="Clicks"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tbad76e34-80b5-48b5-891e-9376ede29c2f place-bottom type-dark"
                                id="Registrations"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
                      ...
                      <div class="!bg-white-100 justify-between !w-130px !min-w-0 sm:!min-w-118px sm:flex-shrink-0 sm:mobile-infoblock-base flex flex-col bg-black-light rounded relative z-[11] overflow-hidden desktop-infoblock-base sm:mobile-infoblock-base">
                        <div class="flex flex-col px-5 pt-5 w-full relative sm:justify-between sm:items-start">
                          <div class="flex items-center z-[10]">
                            ...
                            <div class="relative group">
                              <div
                                class="__react_component_tooltip tfec44900-eaa5-4fd0-ad8f-09bb7cba5a42 place-bottom type-dark"
                                id="Revenue"
                                data-id="tooltip"
                              >
                                {/* <!-- <style aria-hidden="true">
              ...
              <svg
                class="h-20 w-20 mt-4 ml-auto mr-auto"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 44 44"
                stroke="#fff"
              >
